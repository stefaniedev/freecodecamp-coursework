...
- [x] Do not change the value of the global `outerWear`
...
- [x] `testEqual(10)` should return `"Not Equal"`
...
- [x] `testGreaterOrEqual(0)` should return `"9 or Under"`
...
- [x] `testSize(5)` should return `"Small"`
...
- [x] `switchOfStuff(4)` should have a value of `"stuff"`
- [x] You should not use any if or else statements
- [x] You should have at least 3 break statements
...
- [x] `sequentialSizes(1)` should return `"Low"`
...
- [x] Your regular expression should find two occurrences of the word `and`.
- [x] Use regular expressions to find the word and in `testString`.
...
- [x] Your regular expression should find two numbers in `testString`.
- [x] Use the `/\d+/g` regular expression to find the numbers in `testString`.
...
- [x] Your regular expression should find seven spaces in `testString`.
- [x] Use the `/\s+/g` regular expression to find the spaces in `testString`.
