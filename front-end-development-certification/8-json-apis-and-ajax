...
Get a hint
Ask for help on the forum
You should make use of navigator.geolocation to access the users current location.
You should make use of position.coords.latitude to display the users' latitudinal location.
You should make use of position.coords.longitude to display the users' longitudinal location.
You should display the users' position within the data div element
